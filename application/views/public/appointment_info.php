                ...
                <div class="row information">
                    ...
                    <div class="col-sm-6">
                        <div class="information-details">
                            <ul>
                                <li>Nama :<span class="pull-right"><?php echo @$print->family_name .' '. @$print->given_name ;?></span></li>
                                <li>Id Janji Temu :<span class="pull-right"><?php echo $print->appointment_id;?></span></li>
                                <li>Id Pasien :<span class="pull-right"><?php echo $print->patient_id;?></span></li>
                                <li>Tanggal:<span class="pull-right"><?php echo $print->get_date_time;?></span></li>
                                <li>Jam :<span class="pull-right"><?php echo $print->sequence;?></span></li>
                                <li>Dokterr :<span class="pull-right"><?php echo $print->doctor_name;?></span></li>
                                <li>Spesialis :<span class="pull-right"><?php echo $print->specialist;?></span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
