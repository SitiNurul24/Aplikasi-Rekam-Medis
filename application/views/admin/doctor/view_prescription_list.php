                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="prescription">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-xs btn-success" target="_blank" href="<?php echo base_url();?>admin/doctor/Prescription_controller/my_prescription/<?php echo $value->prescription_id; ?>"><i class="fa fa-eye"></i> </a>                                                        
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
