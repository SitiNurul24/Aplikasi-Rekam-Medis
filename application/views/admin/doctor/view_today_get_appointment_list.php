                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-xs btn-primary" data-original-title="View Prescription" target="_blank" href="<?php echo base_url();?>admin/doctor/Prescription_controller/create_prescription/<?php echo $value->appointment_id; ?>"><i class="fa fa-user"></i></a>   
