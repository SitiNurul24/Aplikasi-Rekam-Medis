                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea name="payment_notes" class="form-control" placeholder="Payment Notes"><?php echo $invo->payment_notes;?></textarea>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="date" class="col-sm-4 col-form-label">Pilih Metode Pembayaran <i class="text-danger">*</i></label>
                                    <div class="col-sm-8">
            ...
            $.ajax({
                ...
                'success': function(data){ 
                    ...
                    if (data.patient_id) {
                        ...
                        $(".invlid_patient_id").text(' Nomor Telpon Pasien Terdaftar').addClass("text-success");
                       
                    } else {
                        $('#csc').removeClass('text-success');
                        $(".invlid_patient_id").text('Nomor Telepon Pasien Tidak Valid').addClass("text-danger");
                    }
                }, error   : function() {
                    alert('failed!');
                } 
