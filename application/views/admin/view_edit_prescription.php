                                ...
                                <div class="portlet-title">
                                    <div class="row">
                                        <div class="col-md-8 col-xs-12">
                                            <div class="caption">
                                                <span class="caption-subject font-green sbold uppercase">Nama : </span><?php echo @$pres->patient_name;?>,&nbsp&nbsp&nbsp
                                                <span class="caption-subject font-green sbold uppercase">Umur : </span>
                                                <?php
                                                  ...
                                                  ?>,&nbsp&nbsp&nbsp 
                                                <span class="caption-subject font-green sbold uppercase">Jenis Kelamin : </span><?php echo @$pres->sex;?>,&nbsp&nbsp&nbsp
                                    ...
                                    <div class="portlet-title">
                                         <div class="form-group ">
                                            ...
                                            <div class="col-md-3"><input type="text" class="form-control" value="<?php echo @$pres->weight;?>"  placeholder="<?php echo display('patient_weight')?>" name="Weight" value=""/></div> 
                                            ...
                                            <div class="col-md-3"><input type="text" class="form-control" value="<?php echo @$pres->temperature;?>" placeholder="<?php echo display('temperature')?>" name="temperature"  value=""/></div>
                                        </div>
                                    </div><hr/>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php foreach($m_info as $medicine){?>
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <input type="hidden" class="mdcn_value" name="medicine_id[]" value="<?php echo $medicine->medicine_id?>" />
                                                                            <input type="text"  class="mdcn_name form-control" name="md_name[]"  value="<?php echo $medicine->medicine_name?>" autocomplete="off" placeholder="<?php echo display('medicine_name')?>" />
                                                                            <div id="suggesstion-box"></div>
                                                                        </div>
                                                                        <div class="col-md-1 col-xs-12">
                                                                            <input type="text"  class="form-control" name="type[]" value="<?php echo $medicine->medicine_type?>" placeholder="<?php echo display('type')?>" />
                                                                        </div>


                                                                         <div class="col-md-2" ><input type="text"  class="form-control"  placeholder="<?php echo display('mgml')?>" value="<?php echo $medicine->mg?>" name="mg[]" /></div> 
                                                                         <div class="col-md-1" ><input type="text"  class="form-control"  placeholder="<?php echo display('dose')?>" name="dose[]" value="<?php echo $medicine->dose?>" /></div>
                                                                         <div class="col-md-1"><input type="text"  class="form-control"  placeholder="<?php echo display('day')?>" name="day[]" value="<?php echo $medicine->day?>" /></div>
                                                                         <div class="col-md-3"><input type="text"  class="form-control"  placeholder="<?php echo display('medicine_comment')?>" name="comments[]" value="<?php echo $medicine->medicine_com?>" /></div> 
                                                        ...
                                                        <tr>
                                                            <td colspan="6">
                                                                <div class="form-group col-md-12">
                                                                    <textarea placeholder="<?php echo display('overal_comment')?>" name="prescription_comment" class="form-control" rows="2"> <?php echo @$pres->pres_comments;?></textarea>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                                    ...
                                                                    <?php foreach($t_info as $test){?>
                                                                        ...
                                                                        <div class="form-group ">
                                                                            <div class="col-md-5">
                                                                                ...
                                                                                <input placeholder="<?php echo display('test_name')?>"  value="<?php echo $test->test_name?>" class="test_name form-control" name="te_name[]" autocomplete="off" >
                                                                                <div id="test-box"></div>
                                                                            </div>
                                                                            <div class="col-md-5"> 
                                                                                <input placeholder="<?php echo display('description')?>" value="<?php echo $test->test_assign_description?>" name="test_description[]" class="form-control" ><samp> <?php echo display('discription')?></samp>
                                                                            </div>
                                                                                <a href="javascript:void(0);" class=" btn btn-danger remove_button" title="Remove field"><span class="glyphicon glyphicon-trash"></span></a>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php foreach($a_info as $advice){?>
                                                                    <div id="count_advice1">
                                                                        <div class="form-group ">
                                                                            <div class="col-md-10">
                                                                                <input type="hidden" class="advice_value" value="<?php echo $advice->advice_id?>" name="advice[]" value=""/>
                                                                                <input placeholder="<?php echo display('advice')?>" value="<?php echo $advice->advice?>" class="advice_name form-control" name="adv[]" autocomplete="off" >
...
// ===========================================-->
        ...
        $('body').on('click','#country-list > li',function(){
            ...
            var tab     = $(this).parent().parent().parent().next().children();
            var mg      = $(this).parent().parent().parent().next().next().children();
            var dose    = $(this).parent().parent().parent().next().next().next().children();
            var day     = $(this).parent().parent().parent().next().next().next().next().children();
            var comment = $(this).parent().parent().parent().next().next().next().next().next().children();

            var mdcn_name_val = $(this).val();

            $.ajax({
                url: '<?php echo base_url();?>' + 'admin/Ajax_controller/medicine_dtl/' + mdcn_name_val,
                type: "GET",
                dataType: "JSON",
                success: function(data)
                {
                    if (data) { 
                        tab.val(data.med_type);
                        mg.val(data.med_mg);
                        dose.val(data.med_dose);
                        day.val(data.med_day);
                        comment.val(data.med_comments);
                    }
                },
