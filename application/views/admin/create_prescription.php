            ...
            <div class="content-wrapper">
                ...
                <div class="content">
                    <div class="row">
                        ...
                        <?php echo form_open('admin/Prescription_controller/save_prescription',array('target'=>'_blank'));?>
                            <div class="panel panel-bd prescription-table">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        ...
                                        <?php echo display('sex')?> : <?php echo @$patient_info->sex;?>. Tanggal : <?php echo date("Y-m-d");?> </h4>
