                                ...
                                <tr>  
                                    <th width="40%">
                                        <ul class="list-unstyled"> 
                                            <li>
                                                <strong>No.Telp Pasien</strong>
                                                <input required="" autocomplete="off" name="phone" id="phone" class="invoice-input" type="text">
                                                <p class="text-center text-danger  invlid_patient_id">No.Telp Pasien</p>
                                            </li>   
                                            <li><strong>Nama Lengkap</strong>
                                    ...
                                    <th class="text-center" width="20%"> 
                                        <strong style="border:1px solid #ccc;line-height:60px;padding:5px 10px;">Pembayaran</strong> 
                                    </th>  
                        ...
                        <table id="invoice" class="table table-striped"> 
                            ...
                            <tfoot> 
                                ...
                                <tr>  
                                    ...
                                    <td><button type="reset" class="btn btn-info btn-block">Setel Ulang</button></td>  
                                    <td><button class="btn btn-success btn-block">Simpan</button></td>  
                                    <td></td> 
                                </tr>
                            </tfoot>
                        </table>  
