                            ...
                            <tbody>
                                ...
                                <tr <?php echo ($result)?'style="background-color:  rgb(19, 203, 21)"':''?>>
                                    ...
                                    <td class="text-center" style="width: 100px;">
                                        ...
                                        <?php if($result){?>
                                        <a class="btn btn-xs btn-primary" target="_blank" href="<?php echo base_url();?>admin/Prescription_controller/my_prescription/<?php echo $value->appointment_id; ?>" ><i class="fa fa-indent" aria-hidden="true"></i></a>
                                        <?php }?>
                                    </td>
                                </tr>
                                <?php
