...
*/
	public function patient_list()
	{
		...
		$this->load->view('admin/doctor/view_patient_list');
...
public function today_patient_list(){
    ...
    $this->load->view('admin/doctor/_header',$data);
    $this->load->view('admin/doctor/_left_sideber');
    $this->load->view('admin/doctor/view_today_patient_list');
    $this->load->view('admin/doctor/_footer');
}  
/*
|--------------------------------------
...
*/
	public function create_new_patient()
	{
		...
		$this->load->view('admin/doctor/_left_sideber');
		$this->load->view('admin/doctor/view_create_patient');
		$this->load->view('admin/doctor/_footer');
	}
/*
|--------------------------------------
    ...
    $this->form_validation->set_rules('email', 'Email', 'valid_email|is_unique[log_info.email]');         
      ...
      if ($this->form_validation->run()==true) {
        ...
        #------------------------------------------------#
            ...
            $this->load->view('admin/doctor/_header',$da);
            $this->load->view('admin/doctor/_left_sideber');
            $this->load->view('admin/doctor/view_create_patient_appointment');
            $this->load->view('admin/doctor/_footer');
...
public function delete_patient($patient_id)
{
      ...
      redirect('admin/doctor/Patient_controller/patient_list');
}
...
|--------------------------------------
*/ 
  public function patient_edit($patient_id=NULL)
  {
    $data['patient_info'] = $this->patient_model->get_patient_inde_info($patient_id);
    $this->load->view('admin/doctor/_header',$data);
    $this->load->view('admin/doctor/_left_sideber');
    $this->load->view('admin/doctor/view_edit_patient');
    $this->load->view('admin/doctor/_footer');
  }
...
public function edit_save_patient() {
    ...
    $this->form_validation->set_rules('phone', 'Phone Number is already exist, ', 'trim|required|min_length[6]|max_length[15]');
    $patient_id = $this->input->post('patient_id');
      ...
      if ($this->form_validation->run()==TRUE) {
        ...
        public function patient_info($patient_id=NULL){
            ...
            $this->load->view('admin/doctor/_header',$data);
            $this->load->view('admin/doctor/_left_sideber');
            $this->load->view('admin/doctor/view_patient_info');
            $this->load->view('admin/doctor/_footer');
