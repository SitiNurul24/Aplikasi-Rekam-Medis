...
*/
    ...
    // $this->form_validation->set_rules('patient_id', 'Patient id', 'required');
      $this->form_validation->set_rules('phone', 'No.Telp sudah ada, ', 'trim|required|is_unique[patient_tbl.patient_phone]|min_length[6]|max_length[15]');
...
*/    
  public function edit_save_patient() {
    ...
    $this->form_validation->set_rules('title', 'nama sudah ada, ', 'trim|required');
